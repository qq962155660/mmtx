...
public class RegisterTMRequestTest {
    ...
    public void testToString() throws Exception {
        ...
        registerTMRequest.setApplicationId("mmtx");
        registerTMRequest.setTransactionServiceGroup("daliy_2019");
        registerTMRequest.setVersion("2019-snapshot");
        Assertions.assertEquals("RegisterTMRequest{applicationId='mmtx', transactionServiceGroup='daliy_2019'}",
