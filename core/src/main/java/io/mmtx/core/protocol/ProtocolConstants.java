...
public class ProtocolConstants {
    ...
    /**
     * Configured codec by user, default is MMTX
     * 
     * @see CodecType#MMTX
     */
    public static final byte CONFIGURED_CODEC = CodecType.getByName(ConfigurationFactory.getInstance()
            .getConfig(ConfigurationKeys.SERIALIZE_FOR_RPC, CodecType.MMTX.name())).getCode();
