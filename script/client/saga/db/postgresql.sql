...
CREATE TABLE IF NOT EXISTS public.mmtx_state_machine_def
(
    ...
    CONSTRAINT pk_mmtx_state_machine_def PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS public.mmtx_state_machine_inst
(
    ...
    CONSTRAINT pk_mmtx_state_machine_inst PRIMARY KEY (id),
    CONSTRAINT unikey_buz_tenant UNIQUE (business_key, tenant_id)
)
;
CREATE TABLE IF NOT EXISTS public.mmtx_state_inst
(
    id                       VARCHAR(32)  NOT NULL,
    ...
    excep BYTEA,
    gmt_end                  TIMESTAMP(0) DEFAULT now(),
    CONSTRAINT pk_mmtx_state_inst PRIMARY KEY (id, machine_inst_id)
);
