create table mmtx_state_machine_def
(
...
create table mmtx_state_machine_inst
(
...
create unique index state_machine_inst_unibuzkey on mmtx_state_machine_inst(uni_business_key, tenant_id);

create table mmtx_state_inst
(
    id varchar(32) not null,
