 ...
 */
package io.mmtx.discovery.registry.etcd;
...
import io.mmtx.discovery.registry.etcd3.EtcdRegistryProvider;
import io.mmtx.discovery.registry.etcd3.EtcdRegistryServiceImpl;
...
public class EtcdRegistryServiceImplTest {
    private static final String REGISTRY_KEY_PREFIX = "registry-mmtx-";
