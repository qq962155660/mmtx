 ...
 */
package io.mmtx.discovery.registry.sofa;
...
import static io.mmtx.config.ConfigurationKeys.FILE_ROOT_REGISTRY;
...
public class SofaRegistryServiceImpl implements RegistryService<SubscriberDataObserver> {
    ...
    private static final String DEFAULT_GROUP = "MMTX_GROUP";
