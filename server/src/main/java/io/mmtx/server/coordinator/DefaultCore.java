...
import io.mmtx.core.event.EventBus;
import io.mmtx.core.event.GlobalTransactionEvent;
import io.mmtx.core.exception.BranchTransactionException;
import io.mmtx.core.exception.GlobalTransactionException;
...
import io.mmtx.core.model.ResourceManagerInbound;
import io.mmtx.server.event.EventBusManager;
import io.mmtx.server.lock.LockManager;
import io.mmtx.server.lock.LockerFactory;
import io.mmtx.server.session.BranchSession;
import io.mmtx.server.session.GlobalSession;
import io.mmtx.server.session.SessionHelper;
import io.mmtx.server.session.SessionHolder;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import static io.mmtx.core.exception.TransactionExceptionCode.BranchTransactionNotExist;
import static io.mmtx.core.exception.TransactionExceptionCode.FailedToAddBranch;
import static io.mmtx.core.exception.TransactionExceptionCode.GlobalTransactionNotActive;
import static io.mmtx.core.exception.TransactionExceptionCode.GlobalTransactionStatusInvalid;
import static io.mmtx.core.exception.TransactionExceptionCode.LockKeyConflict;
