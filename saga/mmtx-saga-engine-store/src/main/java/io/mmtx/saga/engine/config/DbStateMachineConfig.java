 ...
 */
package io.mmtx.saga.engine.config;
...
import io.mmtx.saga.engine.impl.DefaultStateMachineConfig;
import io.mmtx.saga.engine.store.db.DbAndReportTcStateLogStore;
import io.mmtx.saga.engine.store.db.DbStateLangStore;
import io.mmtx.saga.tm.DefaultSagaTransactionalTemplate;
...
public class DbStateMachineConfig extends DefaultStateMachineConfig implements DisposableBean {
    ...
    private String tablePrefix = "mmtx_";
