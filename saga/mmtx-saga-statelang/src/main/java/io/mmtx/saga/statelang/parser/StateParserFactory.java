 ...
 */
package io.mmtx.saga.statelang.parser;

import java.util.Map;
import java.util.concurrent.ConcurrentHashMap;

import io.mmtx.saga.statelang.domain.DomainConstants;
import io.mmtx.saga.statelang.parser.impl.ChoiceStateParser;
import io.mmtx.saga.statelang.parser.impl.CompensateSubStateMachineStateParser;
import io.mmtx.saga.statelang.parser.impl.CompensationTriggerStateParser;
import io.mmtx.saga.statelang.parser.impl.FailEndStateParser;
import io.mmtx.saga.statelang.parser.impl.ServiceTaskStateParser;
import io.mmtx.saga.statelang.parser.impl.SubStateMachineParser;
import io.mmtx.saga.statelang.parser.impl.SucceedEndStateParser;
