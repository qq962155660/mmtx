...
import io.mmtx.common.util.BlobUtils;
import io.mmtx.common.util.CollectionUtils;
import io.mmtx.config.ConfigurationFactory;
import io.mmtx.core.constants.ClientTableColumnsName;
...
import io.mmtx.rm.datasource.ConnectionContext;
...
import static io.mmtx.core.exception.TransactionExceptionCode.BranchRollbackFailed_Retriable;
    ...
    public void undo(DataSourceProxy dataSourceProxy, String xid, long branchId) throws TransactionException {
        ...
        for (; ; ) {
            try {
                ...
                // See https://github.com/mmtx/mmtx/issues/489
