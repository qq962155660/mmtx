...
import io.mmtx.core.protocol.AbstractIdentifyRequest;
...
public class RegisterTMRequestCodecTest {
    ...
    public void test_codec() {
        ...
        byte[] body = mmtxCodec.encode(registerTMRequest);

        RegisterTMRequest registerTMRequest2 = mmtxCodec.decode(body);
