...
import io.mmtx.codec.mmtx.MessageCodecFactory;
import io.mmtx.codec.mmtx.MessageMmtxCodec;
...
public class MergedWarpMessageCodec extends AbstractMessageCodec {
    ...
    public <T> void encode(T t, ByteBuf out) {
        ...
        for (final AbstractMessage msg : msgs) {
            ...
            MessageMmtxCodec messageCodec = MessageCodecFactory.getMessageCodec(typeCode);
