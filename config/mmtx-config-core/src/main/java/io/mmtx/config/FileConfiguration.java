...
import io.mmtx.config.ConfigFuture.ConfigOperation;
...
public class FileConfiguration extends AbstractConfiguration {
     ...
     * see io.mmtx.spring.boot.autoconfigure.provider.SpringBootConfigurationProvider#provide
     */
    ...
    public FileConfiguration(String name, boolean allowDynamicRefresh) {
        ...
        /**
         * For mmtx-server side the conf file should always exists.
         * For application(or client) side,conf file may not exists when using mmtx-spring-boot-starter
         */
