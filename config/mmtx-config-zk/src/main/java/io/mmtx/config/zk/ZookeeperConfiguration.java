...
import io.mmtx.config.AbstractConfiguration;
import io.mmtx.config.Configuration;
import io.mmtx.config.ConfigurationChangeEvent;
import io.mmtx.config.ConfigurationChangeListener;
import io.mmtx.config.ConfigurationChangeType;
...
import static io.mmtx.config.ConfigurationKeys.FILE_CONFIG_SPLIT_CHAR;
import static io.mmtx.config.ConfigurationKeys.FILE_ROOT_CONFIG;
import static io.mmtx.config.ConfigurationKeys.MMTX_FILE_ROOT_CONFIG;
...
public class ZookeeperConfiguration extends AbstractConfiguration {
    ...
    private static final String ROOT_PATH = ZK_PATH_SPLIT_CHAR + MMTX_FILE_ROOT_CONFIG;
