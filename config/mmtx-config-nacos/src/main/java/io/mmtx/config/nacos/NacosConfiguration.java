...
public class NacosConfiguration extends AbstractConfiguration {
    ...
    private static final String MMTX_GROUP = "MMTX_GROUP";
    ...
    public String getConfig(String dataId, String defaultValue, long timeoutMills) {
        ...
        try {
            value = configService.getConfig(dataId, MMTX_GROUP, timeoutMills);
    ...
    public boolean putConfig(String dataId, String content, long timeoutMills) {
        ...
        try {
            result = configService.publishConfig(dataId, MMTX_GROUP, content);
        } catch (NacosException exx) {
            LOGGER.error(exx.getErrMsg());
        }
        return result;
    ...
    public boolean removeConfig(String dataId, long timeoutMills) {
        boolean result = false;
        try {
            result = configService.removeConfig(dataId, MMTX_GROUP);
        } catch (NacosException exx) {
            LOGGER.error(exx.getErrMsg());
        }
        return result;
    ...
    public void addConfigListener(String dataId, ConfigurationChangeListener listener) {
        ...
        try {
            ...
            configService.addListener(dataId, MMTX_GROUP, nacosListener);
        } catch (Exception exx) {
        ...
        for (ConfigurationChangeListener entry : configChangeListeners) {
            if (listener.equals(entry)) {
                ...
                if (null != nacosListener) {
                    configService.removeListener(dataId, MMTX_GROUP, nacosListener);
                }
                break;
            }
        }
