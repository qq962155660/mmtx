 ...
 */
package io.mmtx.integration.grpc.interceptor;
...
import io.mmtx.integration.grpc.interceptor.client.ClientTransactionInterceptor;
import io.mmtx.integration.grpc.interceptor.proto.ContextRpcGrpc;
import io.mmtx.integration.grpc.interceptor.proto.Request;
import io.mmtx.integration.grpc.interceptor.proto.Response;
import io.mmtx.integration.grpc.interceptor.server.ServerTransactionInterceptor;
...
public class GrpcTest {
    ...
    public void clientHeaderDeliveredToServer() throws Exception {
        ...
        ListenableFuture<Response> future = stub.contextRpc(Request.newBuilder().setName("mmtx").build());
        assertEquals("hello! mmtx", future.get().getGreet());
