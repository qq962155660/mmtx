 ...
 */
package io.mmtx.rm.tcc.remoting.parser;
...
import io.mmtx.common.util.ReflectionUtil;
import io.mmtx.rm.DefaultResourceManager;
import io.mmtx.rm.tcc.TCCResource;
import io.mmtx.rm.tcc.api.BusinessActionContext;
import io.mmtx.rm.tcc.api.TwoPhaseBusinessAction;
import io.mmtx.rm.tcc.remoting.RemotingDesc;
import io.mmtx.rm.tcc.remoting.RemotingParser;
