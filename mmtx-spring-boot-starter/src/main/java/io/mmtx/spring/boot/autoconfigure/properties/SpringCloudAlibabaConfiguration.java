 ...
 * @author slievrly
 */
@ConfigurationProperties(prefix = StarterConstants.MMTX_SPRING_CLOUD_ALIBABA_PREFIX)
public class SpringCloudAlibabaConfiguration implements ApplicationContextAware {
    ...
    private static final String DEFAULT_SPRING_CLOUD_SERVICE_GROUP_POSTFIX = "-mmtx-service-group";
