...
import io.mmtx.spring.boot.autoconfigure.properties.file.ClientProperties;
import io.mmtx.spring.boot.autoconfigure.properties.file.LockProperties;
import io.mmtx.spring.boot.autoconfigure.properties.file.LogProperties;
import io.mmtx.spring.boot.autoconfigure.properties.file.ServiceProperties;
import io.mmtx.spring.boot.autoconfigure.properties.file.ShutdownProperties;
import io.mmtx.spring.boot.autoconfigure.properties.file.SpringProperties;
import io.mmtx.spring.boot.autoconfigure.properties.file.SupportProperties;
import io.mmtx.spring.boot.autoconfigure.properties.file.ThreadFactoryProperties;
import io.mmtx.spring.boot.autoconfigure.properties.file.TransportProperties;
import io.mmtx.spring.boot.autoconfigure.properties.file.UndoProperties;
import io.mmtx.spring.boot.autoconfigure.properties.registry.ConfigApolloProperties;
import io.mmtx.spring.boot.autoconfigure.properties.registry.ConfigConsulProperties;
import io.mmtx.spring.boot.autoconfigure.properties.registry.ConfigEtcd3Properties;
import io.mmtx.spring.boot.autoconfigure.properties.registry.ConfigFileProperties;
import io.mmtx.spring.boot.autoconfigure.properties.registry.ConfigNacosProperties;
import io.mmtx.spring.boot.autoconfigure.properties.registry.ConfigProperties;
import io.mmtx.spring.boot.autoconfigure.properties.registry.ConfigZooKeeperProperties;
import io.mmtx.spring.boot.autoconfigure.properties.registry.RegistryConsulProperties;
import io.mmtx.spring.boot.autoconfigure.properties.registry.RegistryEtcd3Properties;
import io.mmtx.spring.boot.autoconfigure.properties.registry.RegistryEurekaProperties;
import io.mmtx.spring.boot.autoconfigure.properties.registry.RegistryFileProperties;
import io.mmtx.spring.boot.autoconfigure.properties.registry.RegistryNacosProperties;
import io.mmtx.spring.boot.autoconfigure.properties.registry.RegistryProperties;
import io.mmtx.spring.boot.autoconfigure.properties.registry.RegistryRedisProperties;
import io.mmtx.spring.boot.autoconfigure.properties.registry.RegistrySofaProperties;
import io.mmtx.spring.boot.autoconfigure.properties.registry.RegistryZooKeeperProperties;
...
public class StarterConstants {
    ...
    public static final String MMTX_PREFIX = "mmtx";
    public static final String MMTX_SPRING_CLOUD_ALIBABA_PREFIX = "spring.cloud.alibaba.mmtx";
    public static final String TRANSPORT_PREFIX = MMTX_PREFIX + ".transport";
    ...
    public static final String SERVICE_PREFIX = MMTX_PREFIX + ".service";
    public static final String CLIENT_PREFIX = MMTX_PREFIX + ".client";
    ...
    public static final String REGISTRY_PREFIX = MMTX_PREFIX + ".registry";
    ...
    public static final String CONFIG_PREFIX = MMTX_PREFIX + ".config";
