 ...
 */
package io.mmtx.spring.boot.autoconfigure.provider;
...
import io.mmtx.config.ExtConfigurationProvider;
import io.mmtx.spring.boot.autoconfigure.StarterConstants;
import io.mmtx.spring.boot.autoconfigure.util.SpringUtils;
import io.mmtx.spring.boot.autoconfigure.util.StringFormatUtils;
import org.apache.commons.lang.StringUtils;
import org.springframework.cglib.proxy.Enhancer;
import org.springframework.cglib.proxy.MethodInterceptor;
import org.springframework.cglib.proxy.MethodProxy;

import static io.mmtx.spring.boot.autoconfigure.StarterConstants.NORMALIZED_KEY_CLIENT;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.NORMALIZED_KEY_CLIENT_LOCK;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.NORMALIZED_KEY_CONFIG_APOLLO;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.NORMALIZED_KEY_CONFIG_ZK;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.NORMALIZED_KEY_DATASOURCE_AUTOPROXY;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.NORMALIZED_KEY_GROUPLIST;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.NORMALIZED_KEY_REGISTRY_ZK;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.NORMALIZED_KEY_UNDO;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.NORMALIZED_KEY_TRANSPORT_THREAD_FACTORY;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.NORMALIZED_KEY_VGROUP_MAPPING;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.PROPERTY_MAP;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.SPECIAL_KEY_CLIENT;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.SPECIAL_KEY_CLIENT_LOCK;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.SPECIAL_KEY_CONFIG_APOLLO;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.SPECIAL_KEY_CONFIG_ZK;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.SPECIAL_KEY_DATASOURCE_AUTOPROXY;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.SPECIAL_KEY_GROUPLIST;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.SPECIAL_KEY_REGISTRY_ZK;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.SPECIAL_KEY_UNDO;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.SPECIAL_KEY_TRANSPORT_THREAD_FACTORY;
import static io.mmtx.spring.boot.autoconfigure.StarterConstants.SPECIAL_KEY_VGROUP_MAPPING;
...
public class SpringBootConfigurationProvider implements ExtConfigurationProvider {
    ...
    private String convertDataId(String rawDataId) {
        ...
        return StarterConstants.MMTX_PREFIX + "." + rawDataId;
    }
