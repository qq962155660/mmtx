 ...
 */
package io.mmtx.common.exception;
...
public enum FrameworkErrorCode {
     ...
     */
    InitMmtxClientError("0008", "Mmtx app name or mmtx server group is null", "Please check your configuration"),
     ...
     */
    NetConnect("0101", "Can not connect to the server", "Please check if the mmtx service is started. Is the network connection to the mmtx server normal?"),

    /**
     * The Net reg appname.
     */
    NetRegAppname("0102", "Register client app name failed", "Please check if the mmtx service is started. Is the network connection to the mmtx server normal?"),

    /**
     * The Net disconnect.
     */
    NetDisconnect("0103", "Mmtx connection closed", "The network is disconnected. Please check the network connection to the client or mmtx server."),

    /**
     * The Net dispatch.
     */
    NetDispatch("0104", "Dispatch error", "Network processing error. Please check the network connection to the client or mmtx server."),

    /**
     * The Net on message.
     */
    NetOnMessage("0105", "On message error", "Network processing error. Please check the network connection to the client or mmtx server."),
    /**
